...
Apply the tree against our test set (cross validation) to calculate out of sample accuracy
```
...
We follow the same method as before and check the accuracy against our test set (cross validation).
